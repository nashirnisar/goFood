...
function Carousel() {
  ...
  <form className="d-flex">
      ...
      <button className="btn btn-outline-btn btn-outline-warning" type="submit">Search</button>
    </form>
</div>
    ...
    <div className="carousel-item">
      <img src="https://source.unsplash.com/random/?pastry" className="d-block w-100" style={{filter:"brightness(30%)"}} alt="..."/>
    </div>
    <div className="carousel-item">
